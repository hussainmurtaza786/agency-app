            ...
            >
              ...
              <div className="flex flex-col group justify-center items-center w-full text-center">
                <div className="relative group">
                  <div className="animate-down bg-purple-800 absolute w-[22rem] h-[8rem] -translate-x-[105px] rounded-b-full opacity-0 group-hover:opacity-100 group-hover:scale-100  scale-y-0 scale-x-0 origin-top transition-transform duration-500 ease-in-out"></div>
                  <div className="relative flex justify-center items-center">
                    {/* Color effect */}
                    {/* Border effect */}
                    <div className="z-40 flex justify-center items-center absolute left-4 top-14 inset-0 w-28 h-28 rounded-full border-4 border-teal-500 opacity-0 group-hover:opacity-100 transition-opacity duration-500 ease-in-out"></div>

                    <img
                      className="rounded-full m-6 mt-16 w-24 h-24 object-cover transition-transform duration-500 ease-in-out z-10"
                      src={data.image}
                      alt={data.title}
                    />
                  </div>
